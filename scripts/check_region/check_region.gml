...
/// @description              Function check_region() uses six arguments (x_left,y_top,x_right,y_bottom,_x,_y,) to define area within the current room and then checks to see if the player is in collision with that area.
