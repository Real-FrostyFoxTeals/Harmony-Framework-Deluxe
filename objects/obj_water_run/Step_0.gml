/// @description Script
    ...
    if ((water.pool && obj_player.x >= water.bbox_left && obj_player.x <= water.bbox_right) || !water.pool)
    {
    	...
    	if (global.water_running_effect == 1) {
    		...
    		{
    			//Create effects
    			create_effect(obj_player.x, water.y, spr_water_splash, 0.35, obj_player.depth+1);
